...
public class LaungageProviderJP extends LanguageProvider {

	public LaungageProviderJP(DataGenerator gen, String modid) {
	...
	protected void addTranslations() {
		...
		this.addBlock(BlockInit.DISPLAY_STAND, "ディスプレイスタンド");
		this.addBlock(BlockInit.SIMPLE_PROCESSOR, "簡易組み立て機");
