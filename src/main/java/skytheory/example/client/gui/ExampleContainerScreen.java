...
public class ExampleContainerScreen extends AbstractContainerScreen<ExampleContainerMenu> {
	...
	private static final ResourceLocation BACKGROUND = new ResourceLocation(ExampleMod.MODID, "textures/gui/example_screen.png");

	public ExampleContainerMenu menu;

	public ExampleContainerScreen(ExampleContainerMenu menu, Inventory playerInv, Component component) {
