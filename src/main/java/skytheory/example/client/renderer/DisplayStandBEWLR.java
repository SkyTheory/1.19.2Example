...
public class DisplayStandBEWLR extends BlockEntityWithoutLevelRenderer {

	public static final DisplayStandBEWLR INSTANCE = new DisplayStandBEWLR();
	public static final float COEFFICIENT = (float) (Math.PI / 180.0d);

	private final ModelPart model;

	private DisplayStandBEWLR() {
	...
	public void renderByItem(ItemStack stack, ItemTransforms.TransformType type, PoseStack poseStack, MultiBufferSource bufferSource, int combinedLight, int combinedOverlay) {
		if (stack.getItem() instanceof BlockItem blockItem && blockItem.getBlock() instanceof DisplayStandBlock) {
